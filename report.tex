...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=13cm]{results/exp1-vbox-ping_tr.png}
  \caption{Routing Table via Quagga CLI}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=13cm]{results/exp1-vboxab-rt.png}
  \caption{Routing Table via Quagga CLI}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=13cm]{results/exp1-vboxab-tr.png}
  \caption{Routing Table via Quagga CLI}
